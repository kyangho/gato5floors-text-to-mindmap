...
// Add the plugin
bookshelf.plugin(require('./soft-delete'))
...
You can call every method as usual and this plugin will handle soft
...
This plugin provides a set of overrides so you can customize your
experience while using it.

```js
// Override the field name that holds the deletion date
bookshelf.plugin(require('./soft-delete'), { field: 'deletedAt' })
...
bookshelf.plugin(require('./soft-delete'), { events: false })
...
bookshelf.plugin(require('./soft-delete'), { sentinel: 'active' })
